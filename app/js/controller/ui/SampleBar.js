...
import {SampleControllerUi} from "./controlset/SampleControllerUi";

class SampleBar extends Guify {

    /**
     * @type {SampleControllerUi}
     */
    ui;
    ...
    constructor(id, title, open, object, controller) {
        ...
        this.ui = new SampleControllerUi(object, this.gui);
