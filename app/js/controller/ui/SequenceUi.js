...
class SequenceUi {
     ...
     * @param {GuifyFolder} settingsFolder
     */
    ...
    _initEvents() {
        EventManager.register(EVENT_CLIP_UPDATE, this.index, (config) => {
            this._updateClip(config);
        });
        EventManager.register(EVENT_CLIP_INDICATOR_UPDATE, this.index, (config) => {
