 ...
 */
{
    ...
    HC.AnimationSettingsUi = class AnimationSettingsUi extends HC.PropertyUi {

        addControllers(controlSets) {
            for (let cs in controlSets) {
                let set = controlSets[cs];
                if (set.visible !== false) {
                    let ui = new HC.ControlSetGuifyUi(set, this);
                    ui.addFolder(true);
                    ui.addControllers();
                }
            }
        ...
        addPassesFolder(onChange, props, shaders) {
            ...
            let ui = new HC.ControlSetGuifyUi(props, this);
