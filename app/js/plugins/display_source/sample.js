 ...
 */
{
    /**
     *
     * @type {HC.SourceManager.display_source.Sample}
     */
    HC.SourceManager.display_source.sample = class Sample extends HC.SourceManager.DisplaySourcePlugin {
        ...
        update(width, height) {
            ...
            this.tempo = this.config.ControlSettings.tempo;
            this.width = width;
            this.height = height;
        ...
        _init(reset) {
            ...
            if (!reset) {
                this.duration = Math.ceil(60000 / this.tempo);
        ...
        /**
         * todo better function name. very specific. not needed for the plugin itself?
         * @returns {number}
         */
        last() {
