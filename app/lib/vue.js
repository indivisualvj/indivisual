...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  bind: function () {
	    var el = this.el
	    this.play = document.createComment('v-partial-start')
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  bind: function () {
	    var el = this.el
	    if (!el.__vue__) {
	      this.play = document.createComment('v-if-start')
	  ...
	  teardown: function () {
	    ...
	    transition.blockRemove(this.play, this.end, this.vm)
